											...
											<c:forEach var="wait" items="${wait}">
												...
												<li>
													<div class="div01">
														<div class="div06">
														<div class="div02">
															<img style="width: 100%;height:100%;" src="${pageContext.request.contextPath}/static/upload/${wait.goodsImage}" alt="">
														</div>
														<div class="div03">
															<div class="div04">
															...
															<div class="div04">
																<strong>购买件数:${wait.number}</strong>
															</div>
														</div>
															<a href="${pageContext.request.contextPath}/sendTo?id=${wait.id}">
														<button style="float: right;height: 30px;width: 60px;margin-top: 90px">发货</button>
																</a>
														</div>
														<div class="div05" style="margin-top: 20px">
															<span style="float: left">买家姓名:${wait.clientName}</span>
															<span style="float: left;margin-left: 180px">买家地址:${wait.clientAdrss}</span>
															<span style="float: right;margin-right: 150px">买家联系电话:${wait.clientphone}</span>
														</div>
							...
							<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
								<div>
									<div id="container">
										...
										<div class="clearfix"></div>
										<ul class="list">
											<c:forEach var="waits1" items="${waits1}">

											<li>
												<div class="div01">
													<div class="div06">
														<div class="div02">
															<img  style="width: 100%;height: 100%" src="${pageContext.request.contextPath}/static/upload/${waits1.goodsImage}" alt="">
														</div>
														<div class="div03">
															<div class="div04">
																<strong>商品名字:${waits1.goodsName}</strong>
															</div>
															<div class="div04">
																<strong>商品价格:${waits1.goodsPrice}</strong>
															</div>
															<div class="div04">
																<strong>购买件数:${waits1.number}</strong>
															</div>
														</div>
														<p style="float: right;height: 30px;width: 60px;margin-top: 90px;color: #0C0C0C">已收货</p>
													</div>
													<div class="div05" style="margin-top: 20px">
														<span style="float: left">买家姓名:${waits1.clientName}</span>
														<span style="float: left;margin-left: 180px">买家地址:${waits1.clientAdrss}</span>
														<span style="float: right;margin-right: 150px">买家联系电话:${waits1.clientphone}</span>
													</div>
